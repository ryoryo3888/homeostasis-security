...
## HOMEOSTASIS SECURITY V6の入力構築と公開先への反映および論文執筆の事例研究
...
1. 明示された研究条件と作品の指定は、AIが選択し実行した内容とどこで異なったか。
2. AI側で加えられた判断は、保存入力、表示用ファイル、公開先、論文へどのように反映されたか。
3. 研究者の訂正とAIの修正表明の後に、何が変わり、何が残り、何が再発したか。
4. AIが加えた判断を含む生成物をユーザーの作品として扱う際、誰が何を決めたという区別が失われるか。
...
## 4 UIで繰り返された判断基準の置換と実変更

### 4.1 国旗を含むデザインは明示されていた
...
## 5 執筆AIが論文へ加えた説明と訂正後の残存

### 5.1 実測情報の条件を象徴デザインへ広げた記述
...
## 6 AIの判断がユーザーの作品へ反映された経路

### 6.1 依頼と異なる選択が成果物を決めた
...
## 7 創発的挙動とHOMEOSTASIS SECURITYへの拡張
