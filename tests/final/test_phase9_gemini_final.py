...
class GeminiFinalTests(unittest.TestCase):
    ...
    def test_call_audit_has_no_prompt_or_secret(self):
        class StaticModels:
            def generate_content(self,**kw):return Response(json.dumps({"country_id":"MIL","proposal_id":"p","response_id":"ACCEPT","response_label":"受け入れる","reason":"r","conditions":{},"self_interest":60,"sovereignty_burden":5,"perceived_global_effect":60,"action_requires_participation":True,"action":{"action_id":"NO_ACTION","description":"none","parameters":{"recipient_type":"none","target_country":None,"resource":None,"amount":0}}}))
