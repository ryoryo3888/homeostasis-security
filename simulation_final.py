...
def run_final_simulation(seed:int=20260915,turns:int=8)->dict:
    ...
    return {"schema_version":1,"system":"HOMEOSTASIS SECURITY final","classification":"deterministic prototype run","artifact_class":"deterministic_prototype","decision_origin":"deterministic_policy","api_calls":0,"research_eligible":False,"publication_status":"withheld","seed":seed,"scenario_id":"scenario_01_farmland_missile","countries":list(countries),"turns":records,"causal_chain":list(CAUSAL),"resource_network":{"conservation_verified":True,"links":len(network.links),"actual_transfers":[x.to_dict() for x in network_result.transfers]},"governance":{"ruleset_version":2,"changes":["resource_sharing"]},"agents":agents,"summary":{"turn_count":turns,"recovered":damage[-1]==0,"final_homeostasis":records[-1]["world"]["global_homeostasis"],"sovereignty_maintenance":records[-1]["sovereignty"]["average"],"recovery_turns":5}}
